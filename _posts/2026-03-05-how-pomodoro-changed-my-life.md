...
(Update: instead of pomodoro I now consult an oracle to tell me what to finish, this way I'm not bound by a time limit and feel nore relaxed. Check out my android app [Shintaku](https://github.com/ronynn/shintaku) .
...
Like many others, I spent years feeling perpetually busy, but never quite productive. That was until I discovered the **Pomodoro Technique**—a time management method that has transformed the way I work and helped me reclaim my focus, motivation, and overall well-being. 
...
Before I incorporated the Pomodoro Technique, I often multitasked, jumping between emails, meetings, and personal tasks without a clear structure. I would sit down to work, only to be distracted by a notification or a random thought, most app/game ideas. I never seemed to make a dent in my to-do list, even though I was constantly busy. 

I was juggling multiple projects, deadlines, and personal commitments, and the sheer volume of tasks seemed insurmountable. My mind was constantly buzzing with thoughts about everything I needed to do, which only made it harder to focus on one task at a time. I knew I needed a better system, but I didn’t know where to start. Fun fact, [shintaku](https://github.com/ronynn/shintaku) was created just to solve this.
...
#### 1. Improved Focus and Reduced Distraction
